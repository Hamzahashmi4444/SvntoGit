...
# $Id: BrowseBioSequence.cgi 3350 2005-03-31 00:09:34Z dcampbel $
#
...
sub printEntryForm {
    ...
    $TABLE_NAME="BS_BrowseBioSequence" unless ($TABLE_NAME);
    ($PROGRAM_FILE_NAME) =
...
#    my $limit_clause = "TOP $parameters{row_limit}";
    ...
    %url_cols = ('set_tag' => "$CGI_BASE_DIR/Biosap/ManageTable.cgi?TABLE_NAME=${module_prefix}biosequence_set&biosequence_set_id=\%$colnameidx{biosequence_set_id}V",
