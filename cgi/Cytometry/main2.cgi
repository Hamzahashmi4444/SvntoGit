...
# $Id: main2.cgi 3243 2005-03-21 09:02:00Z edeutsch $
#
...
#		checkGo();
		...
		print $q->start_form (-onSubmit=>"return checkRadioButton()") if  (! $parameters{graphNum});
...
#}
	...
	my $xLabel = $xCoor;
	$xLabel = $xCoorAnother if ($xCoorAnother);
	my $yLabel = $yCoor;
	$yLabel = $yCoorAnother if ($yCoorAnother);
	my $graph;
...
sub printMessage
{
		print "<center><b>This is first time this file has been accessed.<br> Data points need to loaded into the Database.<br> This may take a few minutes.<br> Please be patient</B><br></center>";
		return; 
}
