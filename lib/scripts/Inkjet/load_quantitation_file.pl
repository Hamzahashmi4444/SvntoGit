...
# $Id: load_quantitation_file.pl 2874 2005-01-04 21:45:47Z dcampbel $
#
...
sub main {
  ...
  #### we want to affect the Inkjet portion of the database
  my $work_group = "Inkjet_admin";
  $DATABASE = $DBPREFIX{'Inkjet'};
