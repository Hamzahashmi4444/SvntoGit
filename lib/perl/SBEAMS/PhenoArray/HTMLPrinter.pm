package SBEAMS::PhenoArray::HTMLPrinter;

###############################################################################
# Program     : SBEAMS::PhenoArray::HTMLPrinter
...
sub display_page_header {
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td>Misc:</td></tr>
	<tr><td><a href="$HTML_BASE_DIR/doc/$SBEAMS_SUBDIR/${SBEAMS_PART}_Schema.gif"><nobr>&nbsp;&nbsp;&nbsp;Schema Diagram</nobr></a></td></tr>
        </table>
	</td>
