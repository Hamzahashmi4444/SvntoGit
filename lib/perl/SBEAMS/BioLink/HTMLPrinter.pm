package SBEAMS::BioLink::HTMLPrinter;

###############################################################################
# Program     : SBEAMS::BioLink::HTMLPrinter
...
sub display_page_header {
	...
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_biosequence_set"><nobr>&nbsp;&nbsp;&nbsp;BioSequenceSets</nobr></a></td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_polymer_type"><nobr>&nbsp;&nbsp;&nbsp;Polymer Types</nobr></a></td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_dbxref"><nobr>&nbsp;&nbsp;&nbsp;DB Xrefs</nobr></a></td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_relationship_type"><nobr>&nbsp;&nbsp;&nbsp;Relationship Types</nobr></a></td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_evidence_source"><nobr>&nbsp;&nbsp;&nbsp;Evidence Sources</nobr></a></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_relationship"><nobr>&nbsp;&nbsp;&nbsp;Relationships</nobr></a></td></tr>
	<tr><td><a href="$CGI_BASE_DIR/$SBEAMS_SUBDIR/ManageTable.cgi?TABLE_NAME=BL_evidence"><nobr>&nbsp;&nbsp;&nbsp;Evidences</nobr></a></td></tr>
	<tr><td>&nbsp;</td></tr>
