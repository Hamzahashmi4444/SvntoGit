...
SBEAMS::Microarray::Analysis_Data - Methods to hold data from previous analysis sessions
SBEAMS::Microarray
...
=head1 SYNOPSIS
 ...
 my $analysis_data_o = new SBEAMS::Microarray::Analysis_data;
...
use base qw(SBEAMS::Microarray::Affy_Analysis);		
use SBEAMS::Connection::Tables;
use SBEAMS::Microarray::Tables;
